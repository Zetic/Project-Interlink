...
import {
  ...
  NODE_CARD_PHYSICAL_HEIGHT_METERS,
  NODE_CARD_PHYSICAL_WIDTH_METERS,
  NODE_CARD_WORLD_HEIGHT,
  NODE_CARD_WORLD_WIDTH,
...
function appendResourceCard(group: SVGGElement, resource: ResourceNode): void {
  ...
  body.setAttribute('rx', '3'); body.setAttribute('stroke-width', '1.5');
  ...
  divider.setAttribute('x1', String(-NODE_CARD_LOCAL_HALF_WIDTH)); divider.setAttribute('x2', String(NODE_CARD_LOCAL_HALF_WIDTH));
  divider.setAttribute('y1', String(headerBottom)); divider.setAttribute('y2', String(headerBottom));
  divider.setAttribute('stroke-width', '1'); divider.setAttribute('class', 'ws-map-resource-card-divider'); group.appendChild(divider);
