...
function rounded(value: number, digits = 4): number { return Number(value.toFixed(digits)); }

export function createRegionEnvironment(seed: string, center: Point): RegionEnvironment {
