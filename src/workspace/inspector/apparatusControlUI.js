...
import { installGenericApparatusInspectorUI } from './genericApparatusInspectorUI.js';
...
function installChoiceApparatusControlUI(documentRef = globalThis.document) {
...
export function installApparatusControlUI(documentRef = globalThis.document) {
  ...
  const stopChoices = installChoiceApparatusControlUI(documentRef);
  return () => {
    stopChoices?.();
    stopGeneric?.();
