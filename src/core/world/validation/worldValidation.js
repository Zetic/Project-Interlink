/** Cross-reference and physical-invariant validation for World State. */

import { SCHEMA_VERSION, GENERATOR_VERSION } from '../versions.js';
import { getProcessDefinition } from '../../processes/definitions/index.js';
import { summarizeSolidMaterialBySpecies, totalSolidQuantity, validateSolidMaterialBody } from '../../materials/solids/solidMaterialState.js';
