...
function renderField(canvas, result) {
...
function install() {
    ...
    const width = element('worldgen-width');
    const height = element('worldgen-height');
    ...
    seed.addEventListener('keydown', event => { if (event.key === 'Enter')
        void run(); });
