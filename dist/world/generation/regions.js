...
function suffixForEnvironment(environment) {
...
function createUniqueRegionName(seed, row, column, environment, used) {
...
function sharedVertex(seed, column, row, columns, rows) {
...
export function generateRegions(seed, landmasses) {
