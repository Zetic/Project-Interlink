...
export function createResourceSource(resourceId, rng) {
    ...
    if (!template)
        throw new Error(`No Phase 5 source template for resource '${resourceId}'.`);
    ...
    composition[composition.length - 1].massFraction = Number((composition[composition.length - 1].massFraction + correction).toFixed(12));
    return {
